...
namespace Minimal.Services.SecondaryTilesService
{
    public class SecondaryTileService
    {
        ...
        public bool PinExt(ViewModels.DetailPageViewModelExt vm)
        {
            if (vm == null)
                throw new ArgumentNullException(nameof(vm));
            if (IsPinnedExt(vm))
            ...
            try
            {
                ...
                // pin
                var updater = TileUpdateManager.CreateTileUpdaterForSecondaryTile(nameof(ViewModels.DetailPageViewModelExt));
                var notification = new TileNotification(xml.ToXmlDocument());
                updater.Update(notification);
        ...
        public bool UnPinExt(ViewModels.DetailPageViewModelExt vm)
        {
            if (vm == null)
                throw new ArgumentNullException(nameof(vm));
            if (!IsPinnedExt(vm))
            ...
            try
            {
                var tile = new SecondaryTile(nameof(ViewModels.DetailPageViewModelExt));
                tile.RequestDeleteAsync().AsTask().Wait();
        ...
        public bool IsPinnedExt(ViewModels.DetailPageViewModelExt vm)
        {
            if (vm == null)
                throw new ArgumentNullException(nameof(vm));
            return SecondaryTile.Exists(nameof(ViewModels.DetailPageViewModelExt));
        }
    }
}
